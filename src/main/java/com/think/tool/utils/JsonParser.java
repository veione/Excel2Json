...
public class JsonParser {
        ...
        while (iter.hasNext()) {
            ...
            switch (ch) {
                ...
                case '[':
                    ...
                    map.put(kv.key, TypeUtils.toValue(kv.value));
    ...
    public static void main(String[] args) {
        ...
        final Map<String, Object> jso = JsonParser.parseJSON(str);
        System.out.println("**Compact JSON**");
        System.out.println(jso);
        System.out.println();
        System.out.println("**Compliant JSON**");
        System.out.println(JsonParser.toJSONString(jso, true));
        System.out.println();
        System.out.println("json.basic.0.description = " + JsonParser.getString(jso, "basic", "0", "description"));
    }
